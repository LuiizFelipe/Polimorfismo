...
public class Animais extends Animais1 {
		public static void main(String[] args) {
			...
			System.out.println("Nome do cachorro: "+cachorro.getNome()+"		Idade: "+cachorro.getIdade() +"		Acão: "+cachorro.getAcao() +"			Som: "+cachorro.getEmitirSom());
			System.out.println("Nome do cavalo: "+cavalo.getNome()+"			Idade: "+cavalo.getIdade() +"		Acão: "+cavalo.getAcao()+"				Som: "+cavalo.getEmitirSom());
			System.out.println("Nome do preguiça: "+preguica.getNome()+"		Idade: "+preguica.getIdade() +"		Acão: "+preguica.getAcao()+"			Som: "+preguica.getEmitirSom());
